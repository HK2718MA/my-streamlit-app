...
def load_resources():   
    ...
    le_title = joblib.load(r'C:\Users\HP\Desktop\PROJECT\workspase\le_title.pkl')
    le_wishlist = joblib.load(r'C:\Users\HP\Desktop\PROJECT\workspase\le_wishlist.pkl')
    scaler = joblib.load(r'C:\Users\HP\Desktop\PROJECT\workspase\scaler.pkl')
    
    # Load model
    model = joblib.load(r'C:\Users\HP\Desktop\PROJECT\workspase\rf_model.pkl')
